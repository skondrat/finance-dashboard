  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="bg-surface-container-high rounded-full w-8 h-8 flex items-center justify-center text-on-surface-variant hover:text-on-surface transition-colors"
        aria-label="Settings"
      >
        <GearIcon />
      </button>
